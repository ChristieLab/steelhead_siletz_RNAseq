#---------------- Data Description -------------------------------------------------------------------------------------#
# script written by mark christie on 11/25/2025; contact at markchristie1500@gmail.com
# Rversion: 4.4.3 
...
#setwd("~/Dropbox/manuscripts/steelhead_rna-seq/analyses/siletz/differential_expression")
setwd("C:/Users/fishf/dev/13_steelhead_rna-seq/analyses/siletz/differential_expression/reciprocal_crosses")
setwd("~/Desktop/siletz/analyses/differential_expression/reciprocal_crosses")
library('DESeq2')
library("rtracklayer")
library("ggplot2")
library("gplots")
...
col.data <- read.csv("sample_info_only_reciprocal.csv", row.names = 1)
...
#                              colData = col.data,
#                              design = ~ as.factor(sex)  + cross_type)
...
dds$treatment <- relevel(dds$cross_type, "WxH") ## set the untreated group as the control
dds
